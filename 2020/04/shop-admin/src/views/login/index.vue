  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" size="medium" class="login-form" autocomplete="on" label-position="left">
      ...
      <el-form-item prop="password">
        ...
        <el-input ref="password" :type="passwordType" v-model="loginForm.password" placeholder="密码" @keyup.enter.native="handleLogin" />
...
<style lang="scss" scoped>
  ...
  .login-container {
    min-height: 100%;
    width: 100%;
    background: url('../../assets/images/login_bg_01.jpg') no-repeat top left;
